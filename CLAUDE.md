...
- Follow Laravel's standard design principles.
- Code must comply with PSR-12.
- Prioritize concise descriptions utilizing Laravel features.
- JavaScript should follow React's latest coding conventions.
